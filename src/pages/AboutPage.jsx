      ...
      >
        ...
        >
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              Platform kesehatan holistik yang membantu Anda mencapai
              ...
              <div className="bg-[#f6fefc] dark:bg-[#010907] border-2 border-[#72e4f8] dark:border-[#07798d] hover:border-[#1ff498] dark:hover:border-[#0be084] p-8 rounded-2xl shadow-sm hover:shadow-md transition-all">
                ...
                <div className="space-y-5 text-[#01130c]/80 dark:text-[#ecfef7]/80">
                  ...
                  <p className="leading-relaxed">
                    ...
                    pendamping harian yang dirancang untuk memberdayakan
                    individu dalam membuat keputusan hidup yang lebih baik.
                    Setiap pilar dikembangkan dengan dukungan pakar dan
                    komunitas untuk memastikan relevansi dan dampaknya dalam
                    kehidupan nyata.
                  </p>
                </div>
              </div>
            ...
            <motion.div variants={staggerVariants} className="space-y-6">
              ...
              >
                ...
                <ul className="space-y-3 text-[#01130c]/80 dark:text-[#ecfef7]/80">
                  ...
                  <li className="flex items-start">
                    ...
                    Menyediakan akses ke informasi kesehatan yang mudah
                    dipahami.
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#1ff498] dark:text-[#0be084] mr-2">
                  ...
                  <li className="flex items-start">
                    ...
                    Membantu pengguna dalam mengambil keputusan yang lebih
                    sehat.
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-4 text-[#01130c]/80 dark:text-[#ecfef7]/80">
                  <p className="leading-relaxed">
                    <span className="font-semibold">Visi:</span> Menjadi
                    platform kesehatan digital terdepan yang dapat membantu
                    masyarakat.
                  </p>
                  <p className="leading-relaxed">
                    <span className="font-semibold">Misi:</span> Memberikan
                    solusi kesehatan yang mudah diakses, komprehensif, dan
                    berbasis bukti untuk meningkatkan kualitas hidup masyarakat.
                  </p>
                </div>
              </motion.div>
            </motion.div>
              ...
              >
                {teamMembers.map((member, index) => (
                  <motion.div
                    ...
                    variants={itemVariants}
                    whileHover={{ y: -5 }}
                    className="overflow-hidden rounded-xl border border-[#72e4f8]/30 dark:border-[#07798d]/30"
                  >
              ...
              <motion.div variants={staggerVariants} className="space-y-6">
                ...
                >
                  <div className="flex items-start">
                    ...
                    <p className="leading-relaxed text-[#01130c]/80 dark:text-[#ecfef7]/80">
                      ...
                      Selalu konsultasikan dengan penyedia layanan kesehatan
                      yang memenuhi syarat mengenai pertanyaan medis apa pun.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <p className="leading-relaxed text-[#01130c]/80 dark:text-[#ecfef7]/80">
                      ...
                      risiko pengguna. Tim pengembang tidak bertanggung jawab
                      atas konsekuensi yang timbul dari penggunaan informasi
                      ini.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <p className="leading-relaxed text-[#01130c]/80 dark:text-[#ecfef7]/80">
                      PilarSehat adalah proyek open-source yang dikembangkan
                      untuk tujuan edukasi. Silahkan cek Code nya di{" "}
                      <a
