...
const Home = () => {
  ...
  const testimoniData = [
    {
      image:
        "https://res.cloudinary.com/dxbkwpm3i/image/upload/v1740908252/WhatsApp_Image_2025-03-02_at_16.35.11_f8a5e4ec_dqk9mc.jpg",
  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="relative flex flex-col items-center justify-center min-h-screen px-4 py-16 sm:px-6 lg:px-8 overflow-hidden text-[#01130c] dark:text-[#ecfef7]"
      >
        ...
        >
          <circle cx="50" cy="50" r="5" fill="#1ff498" fillOpacity="0.4" />
          <circle cx="70" cy="70" r="3" fill="#50b7f7" fillOpacity="0.3" />
          <circle cx="30" cy="80" r="4" fill="#0be084" fillOpacity="0.3" />
          <path
            d="M50,50 L70,70 M70,70 L30,80"
            stroke="#72e4f8"
            strokeWidth="1"
            strokeOpacity="0.2"
            fill="none"
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 leading-tight text-[#01130c] dark:text-[#ecfef7]"
          >
            Pilar Kuat untuk{" "}
            <motion.span
      ...
      >
        <motion.div
          variants={itemVariants}
          className="relative max-w-3xl mx-auto my-16 p-8 rounded-2xl bg-gradient-to-r from-[#1ff498]/10 to-[#50b7f7]/10 dark:from-[#0be084]/10 dark:to-[#086faf]/10 border-2 border-[#72e4f8]/30 dark:border-[#07798d]/30 hover:border-[#1ff498] dark:hover:border-[#0be084] transition-all duration-300"
        >
          {/* Decorative Elements */}
          <div className="absolute -left-3 -top-3 w-12 h-12 rounded-full bg-[#1ff498]/20 dark:bg-[#0be084]/20 blur-sm"></div>
          <div className="absolute -right-3 -bottom-3 w-12 h-12 rounded-full bg-[#50b7f7]/20 dark:bg-[#086faf]/20 blur-sm"></div>
          ...
          <div className="relative z-10">
            <p className="text-xl md:text-2xl lg:text-3xl font-medium text-[#01130c] dark:text-[#ecfef7] px-6 md:px-10 leading-relaxed">
              ...
              adalah dua hal yang berbeda, tetapi dengan perbedaan itu akan
              membawa{" "}
              <span className="underline decoration-[#1ff498] dark:decoration-[#0be084]">
            ...
            <div className="mt-6 flex items-center justify-end">
              <div className="w-8 h-px bg-[#1ff498] dark:bg-[#0be084] mr-3"></div>
              <p className="text-[#01130c]/80 dark:text-[#ecfef7]/80 font-medium">
                - Sija69Rek
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative bg-[#f6fefc] dark:bg-[#010907] p-6 rounded-lg shadow-lg">
              ...
              <h3 className="font-bold text-lg mb-2">
                Lihat Bagaimana PilarSehat Bekerja
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <p className="text-[#01130c]/70 dark:text-[#ecfef7]/70 text-base">
              Berikut beberapa pertanyaan yang sering ditanyakan oleh user kami.
      ...
      >
        <div className="text-center mb-12">
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl font-bold text-[#01130c] dark:text-[#ecfef7] mb-4"
          >
            Apa Kata Mereka?
          </motion.h2>
          <motion.p
        ...
        >
          <Swiper
            ...
            className="testimoni-swiper min-h-[300px]" // Added min-height
          >
            {testimoniData.map((testi, index) => (
              <SwiperSlide key={index} className="h-full self-stretch">
                <motion.div className="bg-[#f6fefc] dark:bg-[#010907] rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center h-full border border-[#1ff498]/20 dark:border-[#0be084]/20 relative overflow-hidden">
                  ...
                  <p className="text-sm text-[#01130c]/60 dark:text-[#ecfef7]/60 mb-2">
                    {testi.sekolah}
                  </p>
                  <div className="flex mb-3">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star
                        ...
                        className={`w-4 h-4 ${
                          i < testi.rating
                            ? "text-[#50b7f7] fill-[#50b7f7] dark:text-[#086faf] dark:fill-[#086faf]"
                            : "text-gray-300 dark:text-gray-500"
                        }`}
                      />
                    ))}
                  </div>
                  <p className="text-sm text-[#01130c]/80 dark:text-[#ecfef7]/80 italic relative z-10 flex-grow">
                    "{testi.kesan}"
                  </p>
                  <svg
          ...
          <button
            ...
            className="swiper-button-prev-custom absolute left-0 sm:left-1 md:-left-4 z-20 cursor-pointer p-2 bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 rounded-full shadow-md hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#1ff498] focus:ring-opacity-50"
          >
            <ChevronLeft className="text-[#01130c] dark:text-[#ecfef7] h-5 w-5 md:h-6 md:w-6" />
          </button>
          <button
            aria-label="Testimoni Berikutnya"
            className="swiper-button-next-custom absolute right-0 sm:right-1 md:-right-4 z-20 cursor-pointer p-2 bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 rounded-full shadow-md hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#1ff498] focus:ring-opacity-50"
          >
            <ChevronRight className="text-[#01130c] dark:text-[#ecfef7] h-5 w-5 md:h-6 md:w-6" />
          </button>
        </motion.div>
        <div className="testimoni-pagination-custom flex justify-center items-center pt-8 pb-4"></div>
      </motion.section>
      ...
      SVGs in the "Why Choose PilarSehat" section, inverted the text color to
